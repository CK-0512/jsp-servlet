...
<section>
	<div class="container mx-auto">
		<form action="/Member?cmd=member_join_pro.do" method="POST"
			...
			<div class="table-box-type-1">
				<table class="table">
					...
					<tbody>
						<tr height="100">
							<th>아이디</th>
							<td><input class="input input-bordered input-accent w-3/5"
								type="text" name="loginId" placeholder="아이디를 입력해주세요"
								onblur="loginIdDupChk(this);" />
								<div id="loginIdDupChkMsg" class="text-base mt-2 h-5"></div></td>
						</tr>
						<tr>
							<th>비밀번호</th>
							<td><input class="input input-bordered input-accent w-3/5"
						...
						<tr>
							<th>비밀번호 확인</th>
							<td><input class="input input-bordered input-accent w-3/5"
								type="text" name="loginPwChk" placeholder="비밀번호 확인을 입력해주세요" /></td>
						</tr>
						<tr>
							<th>이름</th>
							<td><input class="input input-bordered input-accent w-3/5"
						...
						<tr>
							<th>닉네임</th>
							<td><input class="input input-bordered input-accent w-3/5"
								type="text" name="nickname" placeholder="닉네임을 입력해주세요" /></td>
						</tr>
						<tr>
							<th>이메일</th>
							<td><input class="input input-bordered input-accent w-3/5"
