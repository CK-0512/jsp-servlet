	...
	<c:forEach var="board" items="${list}">
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="/BoardEditor/board_view.do?idx=${board.idx}&page=${page}">${board.subject}</a></td>
		...
		<c:set var="listcount" value="${listcount-1}" /><!-- listcount 변수 값을 1씩 감소 -->
	</c:forEach>	
</c:if>	
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="board" method="post" action="/BoardEditor/board_list.do">	
			...
			<a href="/BoardEditor/board_write.do?page=${nowpage}"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
