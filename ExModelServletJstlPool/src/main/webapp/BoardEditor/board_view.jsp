   ...
   <style type="text/css">
	...
	<script>
		function board_delete(){
			//url="/Board/board_delete.do?idx="+${board.idx}+"&pasge="+${page};
			url="/BoardEditor/board_delete.do?idx=${board.idx}&page=${page}";
			//url="";
 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       <!-- 새글쓰기 -->
       <a href="/BoardEditor/board_write.do?page=${page}">
       <img src="./img/write.jpg" border="0"></a>&nbsp;&nbsp;
	   <!-- 수정하기 -->
       <a href="/BoardEditor/board_modify.do?idx=${board.idx}&page=${page}">
       <img src="./img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="javascript:board_delete()"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href="/BoardEditor/board_list.do?page=${page}"><img src="./img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
