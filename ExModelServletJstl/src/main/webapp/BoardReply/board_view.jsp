...
<script>
	function board_del(){
		var url="/BoardReply/board_delete.do?page=${page}&idx=${board.idx}";
 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       <!-- 새글쓰기 -->
       <a href="/BoardReply/board_write.do">
       <img src="img/write.jpg" border="0"></a>&nbsp;&nbsp;
	   <!-- 답글쓰기 -->
       <a href="/BoardReply/board_reply.do?idx=${board.idx}">
       <img src="img/reply.gif" border="0"></a>&nbsp;&nbsp;
	   <!-- 수정하기 -->
       <a href="/BoardReply/board_modify.do?idx=${board.idx}">
       <img src="img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="javascript:board_del()"><img src="img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href="/BoardReply/board_list.do"><img src="img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
