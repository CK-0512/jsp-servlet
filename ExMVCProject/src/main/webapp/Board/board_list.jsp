	...
	<c:forEach var="board" items="${list}">
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="/Board?cmd=board_view.do&idx=${board.idx}&page=${page}">${board.subject}</a></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="board" method="post" action="/Board?cmd=board_list.do">	
			...
			<a href="/Board?cmd=board_write.do&page=${page}"><img src="/Board/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
