...
<script>
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <form name="board" method="post" action="/Board?cmd=board_modify.do">
      ...
      <table border="0">
       <tr>
         ...
         <td width="80%">
         <input type="text" size="20" name="name" readonly value="${board.name}" ></td>
       </tr>
       <tr>
         <td align="right">&nbsp;</td>
       ...
       <tr>
        ...
        <tr>
          ...
          <a href="history.back()"><img src="/Board/img/cancle.gif" border=0></a></td></tr>
      </table>
      </form>
    </td></tr>
  </table>
