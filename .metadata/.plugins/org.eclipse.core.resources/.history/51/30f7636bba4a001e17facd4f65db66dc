...
<%@ page import="model.board.*, java.util.*" %>
<%
	//Object nowpage = request.getAttribute("page");
  ...
  <tr>
	...
	%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<font face="돋움" size="2" color="#000000">등록된자료가 없습니다.</font></td>
		</tr>
	...
	%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="/Board/board_view.do?idx=<%= board.getIdx() %>&page=<%=nowpage%>"><%= board.getSubject() %></a></td>
