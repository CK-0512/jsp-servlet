...
<%
	...
	try {
		...
		pstmt = conn.prepareStatement("update tbl_board set readcnt = readcnt + 1 where idx = ?");
		pstmt.setInt(1, idx);
		pstmt.executeUpdate();
...
<script>
	function board_del(idx) {
		...
		window.open(url, "board_delete", "x=150, y=200, width=500, height=220");
	}
</script>
   ...
   <table border="0" width="800">
     <tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com"><%= rs.getString("name") %></a> / <font size="2" face="돋움"><%= rs.getString("regDate") %> / <%= rs.getInt("readcnt") %>번 읽음</font>
      ...
      <font size="2">
	   ...
	   <!-- 수정하기 -->
       <a href="board_modify.jsp?idx=<%=rs.getInt("idx") %>">
