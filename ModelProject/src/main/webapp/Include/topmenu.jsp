...
<html>
 ...
 <table border="0" cellspacing="2" bgcolor="#ecf1ef" width="900" bordercolordark="#ffffff" bordercolorlight="#000000">
   <tr>
     ...
     <p align="center"><font color="white" size="2"><b><a href="/Member/userinfo_login.do" class="white">로그인</A></b></font></p>
     </c:if>
     <c:if test="${!empty user}">
     <p align="center"><font color="white" size="2"><b><a href="/Member/userinfo_logout.do" class="white">로그아웃</A></b></font></p>
     </c:if>
     </td>
     ...
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><a href="/Notice/notice_list.jsp" class="white">공지사항</a></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><a href="/Board/board_list.do?page=1" class="white">게시판</a></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><a href="/Pds/pds_list.do?page=1" class="white">자료실</a></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><a href="/BoardReply/board_list.do?page=1" class="white">질문과답변</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
