...
public class PdsModifyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PdsDTO pds = pDAO.selectPdsNum(idx);
		request.setAttribute("pds", pds);
		request.setAttribute("page", nowpage);
		RequestDispatcher d = request.getRequestDispatcher("pds_modify.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher d = request.getRequestDispatcher("pds_modify_pro.jsp");
		d.forward(request, response);
	}
