...
%>
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000"><%= pds.getIdx() %></font></td>
		<td align="left" height="20">&nbsp;<font face="돋움" size="2"><%= pds.getSubject() %></font></td>
        <td align="center" height="20"><font face="돋움" size="2"><%= pds.getFilename() %></td>
		<td align="left" height="20"><font face="돋움" size="2"><%= pds.getName() %></font></td>
		<td align="left" height="20"><font face="돋움" size="2"><%= pds.getRegdate() %></font></td>
		<td align="center" height="20"><font face="돋움" size="2"><%= pds.getReadcnt() %></font></td> 	      
	  </tr>  	   
<%
	}
%>	  
