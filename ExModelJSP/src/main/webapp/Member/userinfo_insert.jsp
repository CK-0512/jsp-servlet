...
<script>
	function idCheck() {
		window.open("id_check.jsp", "id_check", "left=300, top=200, width=500, height=300");
	}
	
	function send() {
		const join = document.getElementsByName("join")[0];
		join.action = "userinfo_insert_pro.jsp";
		join.submit();
	}
</script>
