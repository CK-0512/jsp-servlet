...
<script>
    function send(idx) {
        const pass = modify.pass.value;
        const originPass = modify.originPass.value;

        if (pass == originPass) {
            if (confirm("정말 수정하시겠습니까?")) {
                modify.action = "board_modify_pro.jsp?idx=" + idx;
                modify.submit();
            } else {
                return false;
            }
     ...
     <form method="post" name="modify">
      ...
      <table border="0">
       <tr>
         ...
         <td width="80%">
         <input type="text" size="20" name="name" value="<%=dto.getName() %>" readonly="readonly" ></td>
       </tr>
       <tr>
         <td align="right">&nbsp;</td>
       ...
       <tr>
        ...
        <tr>
          ...
          <td><a href="javascript:send(<%=idx%>)"><img src="./img/edit2.gif" border=0></a>&nbsp;
