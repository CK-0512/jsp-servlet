    	...
    	아이디를 입력하세요
	    	<form name="idcheck" method="post" action="id_check.jsp">
	           <INPUT NAME=userid type=text size=16 maxlength=16>
	      	   <a href="javascript:idCheck()"><input type=image src="./img/u_bt08.gif" onClick="id_check()" border=0 vspace=0></a>
			</form>
        </TD>
      </TR>
    </TABLE>
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=330>
  ...
  <tr>
    <td colspan=3 align=center>
      <a href="#" onClick="history.back()"><img src="./img/u_bt13.gif" border=0 vspace=5></a>
    </td>
  </tr>
</table>
</BODY>
